...
#warning workaround till the query model source generators are made
        ...
        {
            var dbVersion = new MySqlServerVersion("8.0.33");
            var connectionString = iConfigurationRoot.GetConnectionString(nameof(DatabaseContext));
            dbContextOptionsBuilder.UseMySql(connectionString, dbVersion);
#if DEBUG
