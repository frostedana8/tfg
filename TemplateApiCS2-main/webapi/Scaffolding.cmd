...
dotnet ef dbcontext scaffold "server=localhost;user id=root;password=root;database=db" Pomelo.EntityFrameworkCore.MySql --data-annotations --no-onconfiguring -c DatabaseContext --context-dir Database --output-dir Database/Models --force
IF '%errorlevel%' NEQ '0' (
